...
class RGBQualityAnalyzer:
    ...
    def determine_threshold(self, df):
        ...
        threshold_options = {
            "Conservative (2nd percentile)": np.percentile(df["rgb_std_mean"], 2),
            "Moderate (5th percentile)": np.percentile(df["rgb_std_mean"], 5),
            "Aggressive (10th percentile)": np.percentile(df["rgb_std_mean"], 10),
        }
        ...
        # Use moderate approach (5th percentile) as default
        recommended_threshold = threshold_options["Aggressive (10th percentile)"]

        print(f"\n🎯 Recommended RGB threshold: {recommended_threshold:.4f} (5th percentile)")
    ...
    def generate_exclusion_list(self, df, threshold):
        ...
        exclusion_data = {
            ...
            "threshold_method": "rgb_optical_channels_only_5th_percentile",
            "total_images": len(df),
