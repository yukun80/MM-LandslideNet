...
class LandslideAnnotationTool:
    def __init__(self, iteration: int = 0):
        ...
        self.annotation_request_file = (
            "lightning_landslide/exp/multimodal_swin_tiny_0804/active_learning/annotation_request_iter_0.json"
        )

        self.output_file = f"lightning_landslide/exp/multimodal_swin_tiny_0804/active_learning/annotation_results_iter_{iteration}.json"
        self.output_file_generic = (
            "lightning_landslide/exp/multimodal_swin_tiny_0804/active_learning/annotation_results.json"
        )
